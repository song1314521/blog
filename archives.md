...
<!-- 时间线 -->
<div style="position: absolute; left: 2rem; top: 0; bottom: 0; width: 2px; background: linear-gradient(to bottom, #3eaf7c, #667eea); border-radius: 1px;"></div>
  ...
  <div style="margin-left: 4rem; display: grid; gap: 1rem;">
    ...
    <div style="border: 1px solid #e1e5e9; border-radius: 8px; padding: 1.5rem; background: #fff; box-shadow: 0 2px 8px rgba(0,0,0,0.05); position: relative;">
      ...
      <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.5rem;">
        ...
        <span style="color: #999; font-size: 0.9rem;">01-15</span>
      </div>
      <h3 style="margin: 0.5rem 0; color: #2c3e50;">
        <a href="#" style="text-decoration: none; color: inherit;">Vue 3 Composition API 深度解析</a>
      </h3>
      <p style="color: #666; font-size: 0.9rem; margin-bottom: 1rem;">深入探讨 Vue 3 Composition API 的设计理念和最佳实践...</p>
